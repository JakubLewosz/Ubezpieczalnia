...
|---|---|---|---|
| A01 | Odtworzone EUSAGE na czystym npm 10.9.8/11.6.1 | Uzupełniony lockfile bez aktualizacji istniejących wersji; OCR preflight; oddzielny Compose | npm ci macOS ARM64/Linux ARM64/AMD64; lint/TS/23 testy/build; rzeczywisty build/start i OCR przez worker w Compose. Końcowy zdalny workflow 33974462417: integration + compose SUCCESS; szczegóły poniżej. |
...
Po dołączeniu trwałego dziennika plików pełny backend: **183 passed, 1 skipped /24,45 s**; pominięty był wyłącznie jawnie aktywowany test lokalnego IMAP, wcześniej wykonany osobno z rzeczywistym serwerem. Test dziennika przerwał faktyczny subprocess SIGKILL po zapisie przed commitem i potwierdził późniejsze sprzątnięcie tylko osieroconego klucza. Żywy writer, aktywna dzierżawa i plik z referencją są chronione. Końcowy backend po dodatkowych granicach konfiguracji, CRLF i ręcznym szkicu na Start: **188 passed, 1 skipped /25,22 s**; osobny rzeczywisty test IMAP najnowszego kodu: **1 passed /1,50 s**. Frontend **32 testy** oraz lint/TS/format/build PASS. Końcowy świeży Compose B: **9/9 Playwright /1,8 min**, migracje i 7 usług działają. Backup/restore na oddzielnej bazie zachował 25 tabel, 170 plików, 7 rewizji, 29 maili, 8 załączników i 7 odczytów; źródłowy restart potwierdził pracę/odczyty/cursor bez zmian. Po udokumentowaniu jednej odmiennej pomyłki OCR Tesseract na Ubuntu cały zdalny [workflow 33974462417](https://github.com/JakubLewosz/Ubezpieczalnia/actions/runs/33974462417) na `fffa3c7784bc861489611bdab538a13a7a4d2e32` przeszedł: **integration + compose SUCCESS**. Backend **188 passed, 1 skipped /47,65 s**, następnie osobny rzeczywisty IMAP **1 passed /1,57 s**, frontend **32 testy**, pełny Playwright **9 passed /2,1 min**. Wynik odczytano po zakończeniu przez GitHub API. Szczegóły końcowego biegu są w STATUS.
